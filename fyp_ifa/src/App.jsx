    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          ></Route>{" "}
          {/* creating account with different user domain */}
          <Route
            path="/admin/create/patient/account"
            element={<CreateAccountbyAdmin />}
          ></Route>
          <Route
            path="/admin/view/device/info"
            element={<UpdatePatientTokenByAdmin />}
          ></Route>
          {/*declaring the route for dashboard pages */}
          <Route path="/dashboard" element={<Dashboard />}></Route>
          <Route path="/dashboard/allpatient" element={<AllPatient />}>
            {" "}
          </Route>
          <Route path="/dashboard/assistant" element={<AssignedAssistant />}>
            {" "}
          </Route>
          <Route path="/dashboard/add/patient" element={<AddPatient />}>
            {" "}
          </Route>
          <Route path="/dashboard/remove/patient" element={<RemovePatient />}>
            {" "}
          </Route>
          <Route
            path="/dashboard/critical/patient"
            element={<CriticalPatient />}
          >
            {" "}
          </Route>
          <Route
            path="/dashboard/update/token"
            element={<UpdatePatientToken />}
          >
            {" "}
          </Route>
          ...
          <Route
            path="/patientprofile/medication/:PatientID"
            element={<PatientMedication />}
          >
            {" "}
          </Route>
          <Route
            path="/patientprofile/reports/:PatientID"
            element={<PatientReport />}
          >
            {" "}
          </Route>
          <Route
            path="/patientprofile/notes/:PatientID"

            ...
            <nav className="navbar">
                ...
                <div className="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul className="navbar-nav flex-column">
                        ...
                        <li className="nav-item"><Link to="/dashboard/update/token" className="nav-link hover--effect"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" className="bi bi-person-dash-fill mx-2" viewBox="0 0 16 16"><path fillRule="evenodd" d="M11 7.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5z" /><path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" /></svg>REMOVE HEALTHY PATIENT</Link></li>

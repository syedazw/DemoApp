                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="card mb-5" style={{ color: "white", backgroundColor: "#041342" }}>
                            ...
                            <button className="nav-link btn btn-width align-self-center mb-3 p-1" type="submit" onClick={(e) => navigate(`/patientprofile/medication/${props.id}`)} style={{ color: "white", backgroundColor: "#24a3ac" }}>Add Medicine</button>
                        </div>
                    </div>
                </div>
            </div>
